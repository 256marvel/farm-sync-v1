  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs defaultValue="workers" className="w-full">
        <TabsList aria-label="Farm sections" className="grid grid-cols-5 w-full gap-1 h-auto p-1">
          <TabsTrigger value="workers" aria-label="Workers" className="flex-col sm:flex-row gap-0.5 sm:gap-1.5 py-2 px-1 text-[11px] sm:text-sm">
            <Users className="w-4 h-4" aria-hidden="true" /> Workers
          </TabsTrigger>
